...
// Mason L.
// Nov. 15, 2023
// Creating a tile-based gameboard w/ block pusher
...
function keyPressed(){
  //this should have some edge error cheching...
  if(keyCode === UP_ARROW){
  ...
  if(keyCode === LEFT_ARROW){
    ...
    else if(level[playerY][playerX - 1] === 1){ // if its a chicken
      if(playerX > 1 && level[playerY][playerX - 2]===0){
        //implies that there is room to do a push
